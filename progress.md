...
## 3. Mode Quiz
- [x] 3.1 Afficher une question au hasard (département → capitale ou capitale → département)
- [x] 3.2 Afficher 4 propositions (1 bonne + 3 au hasard)
- [x] 3.3 Valider la réponse et afficher le résultat
- [x] 3.4 Enchaîner les 32 questions
- [x] 3.5 Afficher le score final
- [x] 3.6 Sauvegarder le score dans le `localStorage`
- [x] 3.7 Afficher l'historique des meilleurs scores

### ✅ Tests de validation
- [x] Les 4 propositions sont toujours différentes
- [x] La bonne réponse est toujours parmi les 4 choix
- [x] Le score s'incrémente correctement
- [x] Le score est sauvegardé après fermeture du navigateur
- [x] Le quiz fonctionne sur mobile (boutons facilement cliquables)

---

## 4. Mode Carte interactive
- [x] 4.1 Intégrer la carte SVG de la Colombie
- [x] 4.2 Chaque département est un élément SVG cliquable/colorable
- [x] 4.2.1 Relier chaque zone de la carte SVG aux données du département
- [x] 4.3 Un département s'illumine au hasard
- [x] 4.4 Afficher les deux champs de saisie (département + capitale)
- [x] 4.5 Valider la réponse et colorier le département (vert / jaune / rouge)
- [x] 4.6 Gérer la rotation (verts exclus, jaunes/rouges rejoués)
- [x] 4.7 Détecter la victoire (32 départements verts)
